...
/job discover                           → discover target companies based on your location/keywords
...
| `discover` | Discover companies | Follow job-discover.md |
...
- `~/.claude/skills/job-discover.md` — for target company discovery
